...
export class transaction_payment extends Model<transaction_paymentAttributes, transaction_paymentAttributes> implements transaction_paymentAttributes {

    @Column({
    	primaryKey: true,
    	type: DataType.INTEGER,
    	defaultValue: Sequelize.literal("nextval('payment.transaction_payment_trpa_id_seq'::regclass)") 
    })
    @Index({
    	name: "transaction_payment_pkey",
    	using: "btree",
    	unique: true 
    })
    	trpa_id?: number;
