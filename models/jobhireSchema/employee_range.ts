...
export class employee_range extends Model<employee_rangeAttributes, employee_rangeAttributes> implements employee_rangeAttributes {

    @Column({
    	primaryKey: true,
    	autoIncrement: true,
    	type: DataType.INTEGER,
    	defaultValue: Sequelize.literal("nextval('job_hire.employee_range_emra_id_seq'::regclass)") 
    })
    @Index({
