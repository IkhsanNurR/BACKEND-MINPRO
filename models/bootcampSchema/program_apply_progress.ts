...
export class program_apply_progress extends Model<program_apply_progressAttributes, program_apply_progressAttributes> implements program_apply_progressAttributes {
    ...
    @Index({
    	name: "program_apply_progress_pkey",
    	using: "btree",
    	unique: true 
    })
    	parog_id?: number;
