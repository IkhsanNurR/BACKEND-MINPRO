...
@Table({
	tableName: "users_license",
	schema: "users",
	timestamps: false 
})
export class users_license extends Model<users_licenseAttributes, users_licenseAttributes> implements users_licenseAttributes {
