...
export class sales_order_header extends Model<sales_order_headerAttributes, sales_order_headerAttributes> implements sales_order_headerAttributes {

    @Column({
    	primaryKey: true,
    	type: DataType.INTEGER,
    	defaultValue: Sequelize.literal("nextval('sales.sales_order_header_sohe_id_seq'::regclass)") 
    })
    @Index({
