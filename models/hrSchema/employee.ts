...
export class employee extends Model<employeeAttributes, employeeAttributes> implements employeeAttributes {

    @Column({
    	primaryKey: true,
    	autoIncrement: true,
    	type: DataType.INTEGER,
    	defaultValue: Sequelize.literal("nextval('hr.employee_emp_entity_id_seq'::regclass)") 
    })
    @Index({
    	name: "employee_pkey",
    	using: "btree",
